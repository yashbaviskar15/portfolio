...
export default function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-slate-200/80 py-12 relative z-10 text-slate-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 text-center sm:text-left font-mono">
          <p>Copyright © 2026 Yash Baviskar. All rights reserved.</p>
          <div className="flex items-center gap-3">
            <span>Engineering Portfolio</span>
            <span>•</span>
            <span className="text-purple-600 font-bold">Cloud Engineer & DevOps</span>
          </div>
        </div>
      </div>
    </footer>
